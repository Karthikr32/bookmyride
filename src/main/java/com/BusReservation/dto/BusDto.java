...
public class BusDto {
    ...
    @Pattern(regexp = RegExPatterns.DEPARTURE_AT_REGEX, message = "Departure at must be in (HH:mm:ss) format.")
    private String departureAt;

    @NotNull(message = "Fare amount field is required.")
    @DecimalMax(value = "9999.99", message = "Bus fare is too high.")
